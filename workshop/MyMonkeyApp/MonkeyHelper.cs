...
namespace MyMonkeyApp
{
    public static class MonkeyHelper
    {
        private static readonly List<Monkey> monkeys = new List<Monkey>
        {
            ...
            new Monkey { Name = "Japanese Macaque", Location = "Japan", Population = 1000, Details = "The Japanese macaque, is a terrestrial Old World monkey species native to Japan. They are also sometimes known as the snow monkey because they live in areas where snow covers the ground for months each", ImageUrl = "https://raw.githubusercontent.com/jamesmontemagno/app-monkeys/master/macasa.jpg", Latitude = 36.204824, Longitude = 138.252924 },
